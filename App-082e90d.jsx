...
const content = {
  en: {
    ...
    heritageBody: "For fifteen centuries, the Venetian Republic guarded its secrets beneath the lagoon. AETERNA emerges from these ancient aquifersÔÇöwater untouched by modern contamination, filtered through layers of Alpine stone since the age of the Doges.",
    acquisitionLabel: "The Acquisition",
    acquisitionPrice: "Limited Allocation ┬À Ôé¼80 per 750ml Vessel",
    cta: "REQUEST PURCHASE",
    contactLabel: "Private Inquiries",
    contactEmail: "concierge@aeterna.com",
    footer: "Venice, Italy ┬À Est. 2026",
    ...
    storyChapter1Detail: "In 2024, a small team of researchers and craftspeople gathered in Venice. We weren't looking to create another luxury product. We were seeking to preserve something disappearingÔÇötrue purity.",
    ...
    storyChapter3Detail: "Every bottle is extracted, filtered, and encased in Murano crystal by hand. This is not manufacturingÔÇöit is archaeology. We extract legacy, not commodity.",
    storyChapter4Title: "The Philosophy",
    storyChapter4Text: "AETERNA embodies a single principle: The Luxury of Subtraction.",
    storyChapter4Detail: "In removing everything unnecessary, we reveal what truly matters. No marketing claims. No exaggeration. Just waterÔÇöpure, honest, and silent. It speaks only through its absence of everything else.",
    ...
    originsFinalQuote: "From sky to glassÔÇöthe essence of Venice in every drop.",
    originsTimeline1Title: "The Atmosphere",
    originsTimeline1Text: "Pure humidity suspended above the lagoon, invisible and pristine.",
    originsTimeline1Detail: "At this altitude, water particles are still dispersed in the etherÔÇöpure, untouched, waiting to condense.",
    ...
    purityMoleculeLabel: "HÔééO Molecule",
    purityBack: "Exit Analysis"
  },
  fr: {
    heroTitle: "AETERNA",
    heroSubtitle: "L'├éme de Venise. Distill├®e.",
    heroPreTitle: "Excellence Distill├®e",
    scrollIndicator: "Descendre",
    artifactLabel: "L'Art├®fact",
    artifactTitle: "Puret├® Absolue",
    productNitrates: "Nitrates: 0.00 mg/l",
    productNitratesLabel: "Nitrates",
    productNitratesValue: "0.00 mg/l",
    productOrigin: "Origine: Aquif├¿re V├®nitien",
    productOriginLabel: "Origine",
    productOriginValue: "Aquif├¿re V├®nitien",
    productPHLabel: "├ëquilibre pH",
    productPHValue: "7.4 Optimal",
    productTDSLabel: "TDS",
    productTDSValue: "< 10 ppm",
    productDepthLabel: "Profondeur",
    productDepthValue: "300m Souterrain",
    productVesselLabel: "R├®cipient",
    productVesselValue: "Cristal de Murano",
    bottlePlaceholder: "Image Bouteille",
    bottleCapacity: "750ml Verre de Murano",
    heritageLabel: "L'H├®ritage",
    heritageTitle: "Le Silence dans le Bruit",
    heritageText: "L'histoire est lourde. La puret├® est l├®g├¿re. Nous avons ├┤t├® le bruit pour r├®v├®ler l'essence.",
    heritageBody: "Pendant quinze si├¿cles, la R├®publique de Venise a gard├® ses secrets sous la lagune. AETERNA ├®merge de ces aquif├¿res ancestrauxÔÇöune eau intacte par la contamination moderne, filtr├®e ├á travers des couches de pierre alpine depuis l'├®poque des Doges.",
    acquisitionLabel: "L'Acquisition",
    acquisitionPrice: "Allocation Limit├®e ┬À 80Ôé¼ par Flacon de 750ml",
    cta: "DEMANDER UNE ALLOCATION",
    contactLabel: "Demandes Priv├®es",
    contactEmail: "concierge@aeterna.com",
    footer: "Venise, Italie ┬À Fond├®e en 2026",
    footerLegal: "┬® MMXXVI Aeterna S.r.l.",
    navOrigins: "Origines",
    navPurity: "Puret├®",
    navAcquire: "Acqu├®rir",
    ...
    storySubtitle: "Une Qu├¬te d'Essence",
    storyIntro: "Dans un monde noy├® dans la complexit├®, nous avons cherch├® la simplicit├®.",
    storyChapter1Title: "Le Commencement",
    storyChapter1Text: "Tout grand voyage commence par une question. La n├┤tre ├®tait simple : Et si l'eau pouvait raconter l'histoire de ses origines?",
    storyChapter1Detail: "En 2024, une petite ├®quipe de chercheurs et d'artisans s'est r├®unie ├á Venise. Nous ne cherchions pas ├á cr├®er un autre produit de luxe. Nous cherchions ├á pr├®server quelque chose qui dispara├«tÔÇöla vraie puret├®.",
    storyChapter2Title: "La D├®couverte",
    storyChapter2Text: "Sous la lagune de Venise repose un aquif├¿re intouch├®, scell├® depuis des mill├®naires.",
    storyChapter2Detail: "Les anciens relev├®s g├®ologiques ont r├®v├®l├® des aquif├¿res intouch├®s depuis l'├®poque des Doges. Ces eaux avaient ├®chapp├® ├á la contamination moderne, cach├®es sous 300 m├¿tres de pierre et d'histoire. Nous savions avoir trouv├® quelque chose d'extraordinaire.",
    storyChapter3Title: "L'Art",
    storyChapter3Text: "La perfection exige de la patience. L'excellence exige de la pr├®cision.",
    storyChapter3Detail: "Chaque bouteille est extraite, filtr├®e et ench├óss├®e dans du cristal de Murano ├á la main. Ce n'est pas de la fabricationÔÇöc'est de l'arch├®ologie. Nous extrayons l'h├®ritage, non la marchandise.",
    storyChapter4Title: "La Philosophie",
    storyChapter4Text: "AETERNA incarne un seul principe : Le Luxe de la Soustraction.",
    storyChapter4Detail: "En supprimant tout ce qui est inutile, nous r├®v├®lons ce qui compte vraiment. Aucune affirmation de marketing. Aucune exag├®ration. Juste de l'eauÔÇöpure, honn├¬te, et silencieuse. Elle ne parle que par son absence de tout le reste.",
    storyChapter5Title: "L'Avenir",
    storyChapter5Text: "Nous ne sommes qu'au d├®but d'un plus long voyage.",
    storyChapter5Detail: "Notre r├¬ve n'est pas de devenir omnipr├®sent. C'est de rester rare. De rester v├®ridique. De rester ├®ternel.",
    storyFinalQuote: "Ce que nous faisons est simple. Ce que nous croyons ne l'est pas.",
    storyBack: "Retour ├á l'Accueil",
    // Origins Portal - Aerial Humidity Extraction
    originsTitle: "LE CIEL V├ëNITIEN",
    originsSubtitle: "Une Descente des Cieux",
    originsStory: "De l'air pur au-dessus de Venise, nous capturons l'essence de l'humidit├®.",
    originsAltitudeLabel: "Altitude",
    originsScrollToDescend: "D├®filer pour Descendre",
    originsFinalQuote: "Du ciel au verreÔÇöl'essence de Venise dans chaque goutte.",
    originsTimeline1Title: "L'Atmosph├¿re",
    originsTimeline1Text: "Humidit├® pure suspendue au-dessus de la lagune, invisible et immacul├®e.",
    originsTimeline1Detail: "├Ç cette altitude, les particules d'eau sont encore dispers├®es dans l'├®therÔÇöpures, intactes, attendant de se condenser.",
    originsTimeline2Title: "La Condensation",
    originsTimeline2Text: "Les gouttelettes commencent ├á se former, capturant l'essence de l'air v├®nitien.",
    originsTimeline2Detail: "L'humidit├® rencontre les courants frais des vents adriatiques. Chaque mol├®cule porte des si├¿cles de puret├® atmosph├®rique.",
    originsTimeline3Title: "La Descente",
    originsTimeline3Text: "├Ç travers des couches d'air de plus en plus denses, l'eau prend forme.",
    ...
    originsTimeline4Text: "Les clochers de Venise ├®mergent de la brume matinale.",
    originsTimeline4Detail: "Le brouillard de la lagune accueille chaque goutte. Ici l'air a un go├╗t ancien, de sel et d'histoire.",
    originsTimeline5Title: "La Capture",
    originsTimeline5Text: "Au niveau de la mer, l'eau la plus pure est recueillie.",
    originsTimeline5Detail: "L├á o├╣ le ciel et la lagune se rencontrent, AETERNA na├«t. Chaque bouteille contient un fragment de ciel v├®nitien.",
    originsBack: "Retour ├á la Surface",
    // Purity Portal
    purityTitle: "IMPURET├ë Z├ëRO",
    puritySubtitle: "Perfection Mol├®culaire",
    purityDescription: "Chaque contaminant ├®limin├®. Chaque trace supprim├®e. Ce qui reste est l'essence.",
    purityHeavyMetals: "M├®taux Lourds",
    purityMicroplastics: "Microplastiques",
    purityBacteria: "Bact├®ries",
    purityNitrates: "Nitrates",
    purityPesticides: "Pesticides",
    purityPharmaceuticals: "Pharmaceutiques",
    purityRemoved: "├ëlimin├®",
    purityMoleculeLabel: "Mol├®cule HÔééO",
    purityBack: "Quitter l'Analyse"
  },
  cn: {
    heroTitle: "AETERNA",
    heroSubtitle: "Õ¿üÕ░╝µû»õ╣ïÚ¡éÒÇéÞÉâÕÅûÒÇé",
    heroPreTitle: "ÕìôÞÂèÞÉâÕÅû",
    scrollIndicator: "µÄóþ┤ó",
    artifactLabel: "Þç╗Õôü",
    artifactTitle: "þ╗ØÕ»╣þ║»ÕçÇ",
    productNitrates: "þíØÚà©þøÉ: 0.00 mg/l",
    productNitratesLabel: "þíØÚà©þøÉ",
    productNitratesValue: "0.00 mg/l",
    productOrigin: "õ║ºÕ£░: Õ¿üÕ░╝µû»µÀ▒Õ▒éÕÉ½µ░┤Õ▒é",
    productOriginLabel: "õ║ºÕ£░",
    productOriginValue: "Õ¿üÕ░╝µû»µÀ▒Õ▒éÕÉ½µ░┤Õ▒é",
    productPHLabel: "Úà©þó▒Õ╣│Þíí",
    productPHValue: "7.4 µ£Çõ¢│",
    productTDSLabel: "µ║ÂÞºúÕø║õ¢ô",
    productTDSValue: "< 10 ppm",
    productDepthLabel: "µÀ▒Õ║ª",
    productDepthValue: "Õ£░õ©ï300þ▒│",
    productVesselLabel: "Õ«╣ÕÖ¿",
    productVesselValue: "þ®åµïëÞ»║µ░┤µÖÂ",
    bottlePlaceholder: "þôÂÞ║½Õø¥þëç",
    bottleCapacity: "750µ»½Õìç þ®åµïëÞ»║þÄ╗þÆâ",
    heritageLabel: "õ╝áµë┐",
    heritageTitle: "ÕûºÕÜúõ©¡þÜäÚØÖÞ░º",
    storyChapter5Detail: "µêæõ╗¼þÜäµóªµâ│õ©ìµÿ»µêÉõ©║µùáÕñäõ©ìÕ£¿ÒÇéÞÇîµÿ»õ┐Øµîüþ¿Çµ£ëÒÇéõ┐Øµîüþ£ƒÞ»ÜÒÇéõ┐Øµîüµ░©µüÆÒÇé",
    storyFinalQuote: "µêæõ╗¼µëÇÕüÜþÜäÕ¥êþ«ÇÕìòÒÇéµêæõ╗¼µëÇþø©õ┐íþÜäÕ╣Âõ©ìþ«ÇÕìòÒÇé",
    storyBack: "Þ┐öÕø×õ©╗ÚíÁ",
    // Origins Portal - Aerial Humidity Extraction
    originsTitle: "Õ¿üÕ░╝µû»Õñ®þ®║",
    originsSubtitle: "õ╗ÄÕñ®ÞÇîÚÖì",
    originsStory: "õ╗ÄÕ¿üÕ░╝µû»õ©èþ®║þÜäþ║»ÕçÇþ®║µ░öõ©¡´╝îµêæõ╗¼µìòÞÄÀµ╣┐µ░öþÜäþ▓¥ÕìÄÒÇé",
    originsAltitudeLabel: "µÁÀµïöÚ½ÿÕ║ª",
    originsScrollToDescend: "µ╗ÜÕè¿õ©ïÚÖì",
    originsFinalQuote: "õ╗ÄÕñ®þ®║Õê░µØ»õ©¡ÔÇöÔÇöµ»Åõ©Çµ╗┤Úâ¢Þò┤ÕÉ½Õ¿üÕ░╝µû»þÜäþ▓¥Ú½ôÒÇé",
    originsTimeline1Title: "Õñºµ░öÕ▒é",
    originsTimeline1Text: "µé¼µÁ«õ║Äµ│╗µ╣ûõ©èþ®║þÜäþ║»ÕçÇµ╣┐µ░ö´╝îµùáÕ¢óÞÇîþ║»ÕçÇÒÇé",
    originsTimeline1Detail: "Õ£¿µ¡ñÚ½ÿÕ║ª´╝îµ░┤ÕêåÕ¡Éõ╗ìþäÂÕêåµòúõ║Äõ╗ÑÕñ¬õ©¡ÔÇöÔÇöþ║»ÕçÇÒÇüµ£¬ÕÅùÞºªÕÅèÒÇüþ¡ëÕ¥àÕçØþ╗ôÒÇé",
    originsTimeline2Title: "ÕçØþ╗ô",
    originsTimeline2Text: "µ░┤µ╗┤Õ╝ÇÕºïÕ¢óµêÉ´╝îµìòÞÄÀÕ¿üÕ░╝µû»þ®║µ░öþÜäþ▓¥ÕìÄÒÇé",
    originsTimeline2Detail: "µ╣┐µ░öÚüçõ©èõ║ÜÕ¥ùÚçîõ║ÜµÁÀÚúÄþÜäµ©àÕçëµ░öµÁüÒÇéµ»Åõ©¬ÕêåÕ¡ÉÚâ¢µë┐Þ¢¢þØÇµò░þÖ¥Õ╣┤þÜäÕñºµ░öþ║»ÕçÇÒÇé",
    originsTimeline3Title: "õ©ïÚÖì",
    originsTimeline3Text: "þ®┐ÞÂèµùÑþøèþ¿áÕ»åþÜäþ®║µ░öÕ▒é´╝îµ░┤Õ╝ÇÕºïµêÉÕ¢óÒÇé",
    originsTimeline3Detail: "µÄáÞ┐çÞÁñÚÖÂÕ▒ïÚíÂÕÆîÚ£▓ÕÅ░´╝îÞÆ©µ░öÞ¢¼ÕîûÒÇéÕƒÄÕ©éÕ£¿õ©ïµû╣ÚØÖÚØÖþ¡ëÕ¥àÒÇé",
    originsTimeline4Title: "µÄÑÞ┐æ",
    originsTimeline4Text: "Õ¿üÕ░╝µû»þÜäÚÆƒµÑ╝õ╗ÄµÖ¿Úø¥õ©¡µÁ«þÄ░ÒÇé",
    originsTimeline4Detail: "µ│╗µ╣ûþÜäÚø¥µ░öÞ┐ÄµÄÑµ»Åõ©Çµ╗┤µ░┤ÒÇéÞ┐ÖÚçîþÜäþ®║µ░öÕ©ªþØÇÕÅñÞÇüþÜäµ░öµü»´╝îµÀÀþØÇþøÉÕêåõ©ÄÕÄåÕÅ▓ÒÇé",
    originsTimeline5Title: "µìòÞÄÀ",
    originsTimeline5Text: "Õ£¿µÁÀÕ╣│ÚØó´╝îµ£Çþ║»ÕçÇþÜäµ░┤Þó½µöÂÚøåÒÇé",
    originsTimeline5Detail: "Õñ®þ®║õ©Äµ│╗µ╣ûõ║ñµ▒çõ╣ïÕñä´╝îAETERNAÞ»×þöƒÒÇéµ»Åõ©ÇþôÂÚâ¢Þò┤ÕÉ½Õ¿üÕ░╝µû»Õñ®þ®║þÜäþëçµ«ÁÒÇé",
    originsBack: "Þ┐öÕø×Õ£░Þí¿",
    // Purity Portal
    purityTitle: "ÚøÂµØéÞ┤¿",
    puritySubtitle: "ÕêåÕ¡Éþ║ºÕ«îþ¥Ä",
    purityDescription: "µ»Åõ©Çþºìµ▒íµƒôþë®Þó½µÂêÚÖñÒÇéµ»Åõ©Çõ©ØþùòÞ┐╣Þó½þº╗ÚÖñÒÇéþòÖõ©ïþÜäÕö»µ£ëµ£¼Þ┤¿ÒÇé",
    purityHeavyMetals: "ÚçìÚçæÕ▒×",
    purityMicroplastics: "Õ¥«ÕíæµûÖ",
    purityBacteria: "þ╗åÞÅî",
    purityNitrates: "þíØÚà©þøÉ",
    purityPesticides: "Õå£Þì»",
    purityPharmaceuticals: "Þì»þë®µ«ïþòÖ",
    purityRemoved: "ÕÀ▓µ©àÚÖñ",
    purityMoleculeLabel: "HÔééO ÕêåÕ¡É",
    purityBack: "ÚÇÇÕç║Õêåµ×É"
  }
};
...
const StoryPortal = ({ onClose }) => {
  ...
  const artisanStages = [
    ...
    },
    {
      ...
      detail: 'Master chemists and water specialists work alongside traditional artisans. This is where science meets artÔÇöprecise measurements meet intuitive knowledge passed down through generations.',
    ...
    },
    {
      ...
      detail: 'In the furnaces of Murano, artisans heat glass to 1300┬░C. Every vessel is blown, shaped, and cooled by human hands. No two bottles are ever identicalÔÇöeach carries the fingerprint of its creator.',
...
const PurityPortal = ({ onClose }) => {
  ...
  const chemicalParameters = [
    ...
    { label: 'Conductivity', value: '12', unit: '┬ÁS/cm', optimal: true },
          ...
          <div className="min-h-screen px-3 sm:px-4 md:px-4 py-16 md:py-20 relative">
            ...
            >
              ...
              <span className="text-[9px] font-mono tracking-[0.3em] text-neutral-700 uppercase mt-4 block">
                ÔÇö Aeterna Laboratory Standards
              </span>
